...
/// <summary>Represents a triangle defined by three side lengths (Heron's formula for area).</summary>
public class Triangle : Shape
{
    ...
    /// <summary>Computes area using Heron's formula.</summary>
    private double Area()
    {
    ...
    public override Shape CreateInstance() => new Triangle();
}
